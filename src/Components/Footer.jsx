...
const Footer = () => {
    return (
        <footer className="footer">
          <video className="footer_video" muted loop autoPlay src="//cdn.shopify.com/s/files/1/0526/6905/5172/t/5/assets/footer.mp4?v=29581141968431347981633714450" type="video/mp4"></video>
          <div className="container">
                ...
                <div className="layout">
                  <div className="layout_item w-50">
                    <div className="newsletter">
                      ...
                      <form action="">
                        <input type="text" placeholder="Email Address" className="placeholder-color"/>
                        <button>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" style={{ fill: '#FFC903' }}>
                  ...
                  <div className="layout_item w-25">
                    <nav className="c-nav-tool">
                      ...
                      <ul className="c-nav-tool_list">
                        <li><div className="c-link">Shop All</div></li>
                        <li><div className="c-link">About Us</div></li>
                        <li><div className="c-link">Community</div></li>
                        <li><div className="c-link">Vibes</div></li>
                  ...
                  <div className="layout_item w-25">
                    <nav className="c-nav-tool">
                      ...
                      <ul className="c-nav-tool_list">
                        <li className="c-nav-tool_item"><div href="/pages/shipping-returns" className="c-link">Shipping &amp; Returns</div></li>
                        <li className="c-nav-tool_item"><div href="/pages/help" className="c-link">Help &amp; FAQ</div></li>
                        <li className="c-nav-tool_item"><div href="/pages/terms-conditions" className="c-link">Terms &amp; Conditions</div></li>
                        <li className="c-nav-tool_item"><div href="/pages/privacy-policy" className="c-link">Privacy Policy</div></li>
                        <li className="c-nav-tool_item"><div href="/pages/contact" className="c-link">Contact</div></li>
                        <li className="c-nav-tool_item"><div href="/account/login" className="c-link">Login</div></li>
                      </ul>
                    </nav>
                  </div>
                </div>
                    ...
                    <ul className="flex">
                      <li>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32">
                          <path style={{ fill: '#FFC903' }} d="M0 0h24v24H0z" />
            ...
            <div className="footer_copyright">
              <p>Lighthouse Innovations Inc.</p>
            </div>
          </div>
        </footer>
      );
